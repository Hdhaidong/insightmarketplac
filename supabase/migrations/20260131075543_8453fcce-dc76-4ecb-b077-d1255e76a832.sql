...
CREATE TYPE public.app_role AS ENUM ('influencer', 'seller', 'brand', 'admin');
...
-- Users can insert their own role (only during registration)
...
BEGIN
  -- Get role from user metadata, default to 'seller'
